const passages = [`When you open your eyes for the first time after your death, you know exactly where you are.
...
`In the first month, you fed the sword with your blood.
...
You slid the bottle across the table. "Likely so. I can't make this choice for you, Azinureta - but I would not ask unless I did not think we can complete our Work without it."`,

`Nura grimaced. "Doesn't sound like we have a choice then, Master. God protect me."
...
`You do not. You stare ahead - wondering if she stands somewhere among these shards of building. Or is her presence of a more abstract from?

"Then I will not. What's done is done. Take some measure of revenge from this, if you must - but here we are."`,
...
You don't bother to resume walking. It all seems rather futile, now.`,

`What is happening outside the sword?

You can remember sacrificing Azinureta - even the morning after, where you sobbed as you scraped up her ashes.

You remember the dark irridescence of the finished sword, the glint of each symbol of sacrifice. The overwhelming feeling of urgency and purpose as you took it up to slide it, with a soft hiss, into the sheath.
